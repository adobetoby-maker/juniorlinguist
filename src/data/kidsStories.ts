...
export const KIDS_STORIES: KidsStory[] = [
  ...
  },
  {
    ...
    moduleId: 'travel',
    emoji: '✈️',
    title: 'My First Airplane',
    titleEs: 'Mi primer avión',
    level: 1,
    sentences: [
      { en: 'Today I fly on an airplane for the first time.', es: 'Hoy vuelo en avión por primera vez.' },
      { en: 'My family and I arrive at the airport very early.', es: 'Mi familia y yo llegamos al aeropuerto muy temprano.' },
      { en: 'I show my passport to the guard at the gate.', es: 'Le muestro mi pasaporte al guardia en la puerta.' },
      { en: 'From the window I can see the city and the mountains.', es: 'Desde la ventana puedo ver la ciudad y las montañas.' },
      { en: 'The flight attendant gives us water and a snack.', es: 'La azafata nos da agua y un bocadillo.' },
      { en: 'After two hours, the airplane lands on the beach side.', es: 'Después de dos horas, el avión aterriza junto a la playa.' },
      { en: 'I can already smell the ocean and feel the adventure!', es: '¡Ya puedo oler el océano y sentir la aventura!' },
    ],
    question: 'What does the flight attendant give them?',
    answerHint: 'water and a snack',
  },
  {
    id: 'the-painting-class',
    moduleId: 'arts',
    emoji: '🎨',
    title: 'The Painting Class',
    titleEs: 'La clase de pintura',
    level: 1,
    sentences: [
      { en: 'Today is painting class and I am very excited.', es: 'Hoy es la clase de pintura y estoy muy emocionado.' },
      { en: 'The teacher gives each student a canvas and brushes.', es: 'La maestra le da a cada estudiante un lienzo y pinceles.' },
      { en: 'I choose blue, yellow, and green colors.', es: 'Elijo los colores azul, amarillo y verde.' },
      { en: 'I paint a big tree with birds singing in the branches.', es: 'Pinto un árbol grande con pájaros cantando en las ramas.' },
      { en: 'My friend draws a guitar next to her painting.', es: 'Mi amiga dibuja una guitarra junto a su pintura.' },
      { en: 'At the end, we hang all the paintings on the wall.', es: 'Al final, colgamos todas las pinturas en la pared.' },
      { en: 'The classroom looks like a real museum!', es: '¡El salón parece un museo de verdad!' },
    ],
    question: 'What does the narrator paint?',
    answerHint: 'a big tree with birds',
  },
  {
    id: 'a-big-feeling-day',
    moduleId: 'body',
    emoji: '💛',
    title: 'A Big Feeling Day',
    titleEs: 'Un día de grandes sentimientos',
    level: 1,
    sentences: [
      { en: 'This morning I wake up feeling excited and a little scared.', es: 'Esta mañana me despierto emocionado y un poco asustado.' },
      { en: 'Today is my first day at a new school.', es: 'Hoy es mi primer día en una escuela nueva.' },
      { en: 'My heart beats fast and my head feels dizzy.', es: 'Mi corazón late rápido y mi cabeza se siente mareada.' },
      { en: 'A friendly classmate says hello and makes me laugh.', es: 'Un compañero simpático me saluda y me hace reír.' },
      { en: 'By lunchtime I feel happy and strong.', es: 'Para el almuerzo me siento feliz y fuerte.' },
      { en: 'On the way home I tell my family about my new friend.', es: 'De camino a casa le cuento a mi familia sobre mi nuevo amigo.' },
      { en: 'Big feelings come and go — that is how we grow.', es: 'Los grandes sentimientos van y vienen — así es como crecemos.' },
    ],
    question: 'What makes the narrator laugh?',
    answerHint: 'a friendly classmate',
  },
]

    ...
    >
      <div className={`flip-inner w-full h-full${flipped ? ' flipped' : ''}`}>
        ...
        >
          ...
          <p className="text-sm font-semibold" style={{ color: '#71717A', fontFamily: '"Nunito", sans-serif' }}>Tap to reveal Spanish →</p>
        </div>
        {/* Back — Spanish */}
        <div
        ...
        >
          <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.7)', fontFamily: '"Nunito", sans-serif' }}>Spanish</p>
